...
def train_and_evaluate(config):
    ...
    train_data = torch.load(os.path.join(base, "training_2_gnn.pt"),
                            map_location='cpu', weights_only=False)
    val_data   = torch.load(os.path.join(base, "validation_2_gnn.pt"),
                            map_location='cpu', weights_only=False)
    test_data  = torch.load(os.path.join(base, "test_2_gnn.pt"),
                            map_location='cpu', weights_only=False)
