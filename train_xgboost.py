...
# ─── CONFIGURATION ──────────────────────────────────────────────────────────────
BASE_DIR       = r"C:\Users\fotis\Downloads"   # adjust to your root folder
SETS           = ["Training_2", "Validation_2", "Test_2"]
FEATURE_SUBDIR = "features"                    # subfolder containing *_features.csv
SCALER_OUT     = os.path.join(BASE_DIR, "xgb_scaler_2.pkl")
MODEL_OUT      = os.path.join(BASE_DIR, "xgb_tuned_model_2.pkl")
...
X_train, y_train, feature_names = load_feature_split("Training_2")
X_val,   y_val,   _             = load_feature_split("Validation_2")
X_test,  y_test,  _             = load_feature_split("Test_2")
