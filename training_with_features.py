...
# ─── CONFIG ─────────────────────────────────────────────────────────────────────
BASE           = r"C:\Users\fotis\Downloads"
SETS           = ["Training_2", "Validation_2", "Test_2"]
FEATURE_SUBDIR = "features"
SCALER_OUT     = os.path.join(BASE, "rf_scaler.pkl")
MODEL_OUT      = os.path.join(BASE, "rf_model.pkl")
...
X_train = scaler.transform(X["Training_2"])
X_val   = scaler.transform(X["Validation_2"])
X_test  = scaler.transform(X["Test_2"])
